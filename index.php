...
<head>
    ...
    <title>Halaman Login | Sumber Barokah Rezeki</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-success shadow-lg p-5 text-center">
                                ...
                                <h3 class="text-white"> <b>Sumber Barokah Rezeki</b>
                                    <br>
                                    <small>Kp Pasiripis Desa Kertawangi</small>
                                    <br> <small>Cisarua Bandung Barat</small>
                                </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">by Sumber Barokah Rezeki | 2023 - <?= date('Y') ?></a>
                                    </div>
